...
<svelte:head>
	...
	<link rel="stylesheet" href="new/dist/css/style.css" />
	...
	<div class="is-boxed">
				...
				<div class="container">
					<div class="site-header-inner">
						<div class="brand header-brand">
							<h1 class="m-0">
								<a href="/">
									<img src="new/images/logo.png" width="150" alt="" />
								</a>
							</h1>
						</div>
					</div>
					...
					<div class="container">
						<div class="hero-inner">
							...
							<div class="hero-illustration">
								...
								<div
									class="hero-square hero-square-1 is-moving-object is-rotating"
								>
									<svg
										width="220"
										height="220"
								...
								<div
									class="hero-square hero-square-2 is-moving-object is-rotating"
								>
									<svg
										width="88"
										height="88"
								...
								<div
									class="hero-square hero-square-3 is-moving-object is-rotating"
								>
									<svg
										width="64"
										height="64"
								...
								<div
									class="hero-square hero-square-4 is-moving-object is-rotating"
								>
									<svg
										width="320"
										height="320"
								...
								<div
									class="hero-square hero-square-5 is-moving-object is-rotating"
								>
									<svg
										width="141"
										height="140"
								...
								<div
									class="hero-square hero-square-6 is-moving-object is-rotating"
								>
									<svg
										width="128"
										height="128"
								...
								<div
									class="hero-square hero-square-7 is-moving-object is-rotating"
								>
									<svg
										width="64"
										height="64"
								...
								<div
									class="hero-square hero-square-8 is-moving-object is-rotating"
								>
									<svg
										width="40"
										height="40"
								...
								<div class="feature">
									<div class="feature-inner">
										...
										<p class="text-sm mb-0">
											...
											printing in place of things to emphasise design elements.
										</p>
									</div>
								</div>
								<div class="feature">
				...
				<div class="container">
					<div class="site-footer-inner has-top-divider">
						<div class="footer-copyright">
							&copy; 2022 Tonvolt, All rights reserved.
						</div>
					</div>
				</div>
			</footer>
		...
		<script src="new/dist/js/main.min.js"></script>	
	</div>
